...
class Trader:
    ...
    def get_stocks_current_price(self, stocks: Union[str, list]):
        """
    ...
    def buy_stock(self, ticker: str, price: float):
        """
    ...
    def sell_stock(self, ticker: str, price: float = None):
        """
        ...
        """
        if price is None:
            total = self.get_my_stocks()[ticker]['price']
        else:
            total = price
