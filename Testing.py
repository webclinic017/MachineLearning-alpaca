...
def predict_stock_prices(run, lines=None):
    """
    ...
    listOfTickers = [(line.strip(), custom_id, NEPTUNE_API_TOKEN) for line in lines if line.strip() not in blacklist]
...
if __name__ == '__main__':
    ...
    stock_predictions, news_sentiment = predict_stock_prices(run_1)
    ...
    orders_to_buy = create_orders(stock_predictions, news_sentiment, run_1)
    try:
